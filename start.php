...
require PATH . 'models/message.php';
...
View::add_locals('title', $config['name_app']); // Añade a locals el título de la aplicación para poder usarlo en cualquier plantilla.
